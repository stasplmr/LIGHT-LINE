...
<div id="content">
    ...
    <div class="subs-description">
        <h3>Premium+</h3>
        <?php echo $lang['premiumDesc'] ?><br>
        <div class="list"> <?php echo $lang['premiumList']?> </div>
        <?php echo $lang['premiumTime'] ?><br>
        <h4><?php echo $lang['month'] ?></h4>
        <?php echo $lang['premiumMonthFeatures'] ?>
        <?php echo $lang['premiumMonthAdvantages'] ?>
        <h4><?php echo $lang['halfYear'] ?></h4>
        <?php echo $lang['premiumHalfFeatures'] ?>
        <?php echo $lang['premiumHalfAdvantages'] ?>
        <h4><?php echo $lang['year'] ?></h4>
        <?php echo $lang['premiumYearFeatures'] ?>
        <?php echo $lang['premiumYearAdvantages'] ?>
    </div>
</div>
<div id="footer">
        LIGHT-LINE fitness 2021<br><?php echo $lang['selectedLang']?>
        <ul class="social-links">
            <li><a class="icon-ukr" href="subscriptions_premium.php?lang=uk" title="..." rel="noopener"></a></li>
            <li><a class="icon-eng" href="subscriptions_premium.php?lang=en" title="..." rel="noopener"></a></li>
            <li><a class="icon-rus" href="subscriptions_premium.php?lang=ru" title="..." rel="noopener"></a></li>
        </ul>
</div>
</body>
</html>